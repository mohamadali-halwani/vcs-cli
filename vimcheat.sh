...
+  printf "  %b--search%b TERM       Search commands matching TERM\n" "$COL_CMD" "$RESET"
+  printf "  %b--category%b NAME     Show commands for category NAME\n" "$COL_CMD" "$RESET"
+  printf "  %b--categories%b        List all categories\n" "$COL_CMD" "$RESET"
+  printf "  %b--all%b               Display full cheat sheet\n" "$COL_CMD" "$RESET"
